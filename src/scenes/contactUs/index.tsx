...
const ContactUs = ({ setSelectedPage }: Props) => {
	...
	return (
		<section id="conactus" className="mx-auto w-5/6 pb-32 pt-24">
			<motion.div
				onViewportEnter={() => setSelectedPage(SelectedPage.ConactUs)}
			>
				{/* HEADER */}
				<motion.div
					className="md:w-3/5"
				...
				<div className="mt-10 justify-between gap-8 md:flex">
					...
					>
						<form
							...
							onSubmit={onSubmit}
							method="POST"
							action="https://formsubmit.co/volodya1234321@gmail.com" // TODO write email here
						>
							<input
